...
export default function KnowledgePage() {
    ...
    return (
        <div style={{ display: 'flex', flexDirection: 'column', height: '100%', backgroundColor: 'var(--bg-primary)' }}>
                        ...
                        {selectedItem ? (
                                ...
                                <div style={{
                                    ...
                                    <div>
                                        ...
                                        <div style={{ fontWeight: '600', color: 'var(--text-primary)' }}>
                                            {selectedItem.itemType}: {selectedItem.content.slice(0, 80)}{selectedItem.content.length > 80 ? '…' : ''}
                                        </div>
                                    </div>
                            ...
                            <div style={{
                                ...
                                <p style={{ fontSize: '0.875rem' }}>
                                    Click a node in the Graph tab to explore its backlinks
                                </p>
                                <button
            ...
            {/* Edit modal (triggered from backlinks header) */}
            <KnowledgeItemModal
                isOpen={isModalOpen}
